      ...
      messages: [
        {
          role: 'system',
          content:
            'You are helpful assistant. Your job is summarize the article accessible through the provided link in one sentence in Korean, and extract three keywords that can be used for classification purposes.',
        },

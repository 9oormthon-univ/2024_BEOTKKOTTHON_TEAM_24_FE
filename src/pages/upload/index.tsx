...
const LinkInput: NextPage = ({}) => {
  ...
  useEffect(() => {
    if (result.title) { // ai 가공 결과 정상 반환 시 제목, 요약, 키워드를 다음 페이지로 전달
      router.push({
      ...
      <PageContainer>
          ...
          <ImageSection>
            ...
            <ImageListContainer className='no-scroll'>
              ...
              <AddBtnWrapper>
                <label htmlFor="imgfile">
                  <svg xmlns="http://www.w3.org/2000/svg" className="add-btn" width="35" height="35" viewBox="0 0 35 35" fill="none">
                    <circle cx="17.5" cy="17.5" r="17.5" fill="#D9D9D9"/>
                    <path d="M17.5 9.625V25.375" stroke="#353535" strokeWidth="2.3" strokeLinecap="round"/>
                    <path d="M25.375 17.5L9.625 17.5" stroke="#353535" strokeWidth="2.3" strokeLinecap="round"/>
                  </svg>
                </label>
                <FileInput type="file" onChange={handleImage} name="imgfile" id="imgfile" accept='.png, .jpeg, .jpg,' multiple/>
              </AddBtnWrapper>
          ...
          <MemoSection>
            ...
            <MemoWrapper>
              <MemoInput value={memo} onChange={(e) => handleMemo(e.target.value)}/>
          ...
          <div className='absolute'>
            <MoveToNextBtn
              ...
              isDisabled={linkInput.length === 0 && memo.length === 0}/>
          </div>
